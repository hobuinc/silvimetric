...
@pytest.fixture(scope='function')
def western_config(western_filepath, WesternBounds, resolution, WebMercator,
        attrs, metrics) -> Generator[StorageConfig, None, None]:
    log = Log(20)
...
@pytest.fixture(scope='function')
def western_shatter_config(western_pipeline, western_storage, bounds, date) -> Generator[ShatterConfig, None, None]:
    log = Log(20) # INFO
